...
{
    public class CustomerRepository : Repository<Customer, CustomerId, AppCommandDbContext>, ICustomerRepository
    {
        public CustomerRepository(AppCommandDbContext dbContext) : base(dbContext) { }
        ...
        public async Task<bool> ExistAsync(CustomerId customerId, CancellationToken cancellationToken = default)
        {
